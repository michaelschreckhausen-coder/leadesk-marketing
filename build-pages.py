  ...
  <div class="container container--wide">
    ...
    <div class="reveal" style="max-width: 940px; margin: 0 auto;">
      <div class="screenshot">
        ...
        <div class="screenshot__body"><div class="screenshot__placeholder"><div class="screenshot__icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/></svg></div><div class="screenshot__label">ModelSelector im Content Studio</div><div class="screenshot__hint">Screenshot folgt</div></div></div>
      </div>
    </div>
