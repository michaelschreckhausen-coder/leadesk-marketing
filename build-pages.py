...
def nav(active=None):
    ...
    <nav class="nav">
      <div class="nav__inner">
        ...
        <div class="nav__cta">
          <a href="{APP_URL}" class="nav__login">Anmelden</a>
          <a href="{APP_URL}" class="btn btn--primary btn--sm">Kostenlos starten</a>
        </div>
      </div>
    </nav>
    """)
...
def footer_cta(title_html="Mehr Pipeline.<br>Weniger Stress.", sub="14 Tage kostenlos testen. Keine Kreditkarte, keine Verlängerungsfalle.", cta_label="Kostenlos starten"):
    return dedent(f"""\
    <section class="footer-cta">
      <div class="container footer-cta__inner">
        ...
        <div class="reveal">
          <a href="{APP_URL}" class="btn btn--on-blue btn--lg">
